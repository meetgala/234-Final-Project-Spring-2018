...
wget --no-check-certificate https://s3.amazonaws.com/evi-ds-module/bbradshaw_fbml_data.tar.gz

# Unzip the file
echo "Unzipping tarball."
tar -xvzf nhanes_data.tar.gz
tar -xvzf bbradshaw_fbml_data.tar.gz
...
#mv bbradshaw_fbml_data.tar.gz
#mv bbradshaw_fbml_data.csv
